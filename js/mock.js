	...
	_set_default_property_values() {
		for ( let property_type of Object.keys(this._mock_data.greeter.properties) ) {
			for ( let property of this._mock_data.greeter.properties[property_type] ) {
				...
				this[`_hostname`] = this._mock_data.greeter.hostname
			}
		}
...
let MockData = () => ({
	...
	users: [
		{
			display_name: 'Lain Iwakura',
			language: null,
			layout: null,
			image: '/usr/share/lightdm-webkit/themes/antergos/img/antergos-logo-user',
			home_directory: '/home/kurigohan',
			username: 'lain',
			logged_in: false,
			session: 'dwm',

			name: 'lain',
			real_name: 'Lain Iwakura'
		},
		{
			display_name: 'Makise Kurisu',
			language: null,
			layout: null,
			image: '/usr/share/lightdm-webkit/themes/antergos/img/antergos-logo-user',
			home_directory: '/home/kurigohan',
			...
			name: 'kurigohan',
			real_name: 'Makise Kurisu'
		},
		{
			display_name: 'Hitagi Senjougahara',
			language: null,
			layout: null,
			image: '/usr/share/lightdm-webkit/themes/antergos/img/antergos-logo-user',
			home_directory: '/home/senjougahara',
			username: 'senjougahara',
			logged_in: false,
			session: 'dwm',

			name: 'senjougahara',
			real_name: 'Hitagi Senjougahara'
		}
	],
	hostname: "MOCK"
});
